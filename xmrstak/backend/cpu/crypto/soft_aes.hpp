...
alignas(TABLE_ALIGN) const uint32_t saes_table[4][256] = { saes_data(saes_u0), saes_data(saes_u1), saes_data(saes_u2), saes_data(saes_u3) };
alignas(TABLE_ALIGN) const uint8_t saes_sbox[256] = saes_data(saes_h0);
