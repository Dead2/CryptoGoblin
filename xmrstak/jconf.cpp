...
xmrstak::coin_selection coins[] = {
    ...
    // {newalgo, oldalgo, fromversion}
#ifndef ONLY_XMR_ALGO
    { "aeon",                           {POW(cryptonight_aeon),             POW(cryptonight_aeon),              0u }, {POW(cryptonight_aeon),       POW(cryptonight_aeon),      0u }, "mine.aeon-pool.com:5555" },
    { "bbscoin",                        {POW(cryptonight_aeon),             POW(cryptonight_aeon),              0u }, {POW(cryptonight_aeon),       POW(cryptonight_aeon),      0u }, nullptr },
    ...
    { "cryptonight",                    {POW(cryptonight),                  POW(cryptonight),                   0u }, {POW(cryptonight_r),          POW(cryptonight_r),         0u }, nullptr },
    ...
    { "cryptonight_conceal",            {POW(cryptonight_conceal),          POW(cryptonight_conceal),           0u }, {POW(cryptonight_r),          POW(cryptonight_r),         0u }, nullptr },
    ...
    { "cryptonight_lite",               {POW(cryptonight_lite),             POW(cryptonight_lite),              0u }, {POW(cryptonight_aeon),       POW(cryptonight_aeon),      0u }, nullptr },
    { "cryptonight_lite_v7",            {POW(cryptonight_aeon),             POW(cryptonight_aeon),              0u }, {POW(cryptonight_aeon),       POW(cryptonight_aeon),      0u }, nullptr },
    { "cryptonight_lite_v7_xor",        {POW(cryptonight_ipbc),             POW(cryptonight_ipbc),              0u }, {POW(cryptonight_aeon),       POW(cryptonight_aeon),      0u }, nullptr },
    { "cryptonight_masari",             {POW(cryptonight_masari),           POW(cryptonight_masari),            0u }, {POW(cryptonight_r),          POW(cryptonight_r),         0u }, nullptr },
    { "cryptonight_superfast",          {POW(cryptonight_superfast),        POW(cryptonight_superfast),         0u }, {POW(cryptonight_r),          POW(cryptonight_r),         0u }, nullptr },
    ...
    { "cryptonight_r_wow",              {POW(cryptonight_r_wow),            POW(cryptonight_r_wow),             0u }, {POW(cryptonight_r),          POW(cryptonight_r),         0u }, nullptr },
    ...
    { "freehaven",                      {POW(cryptonight_superfast),        POW(cryptonight_superfast),         0u }, {POW(cryptonight_r),          POW(cryptonight_r),         0u }, nullptr },
    { "graft",                          {POW(cryptonight_v8_reversewaltz),  POW(cryptonight_monero_v8),        12u }, {POW(cryptonight_r),          POW(cryptonight_r),         0u }, nullptr },
    { "haven",                          {POW(cryptonight_haven),            POW(cryptonight_haven),             0u }, {POW(cryptonight_heavy),      POW(cryptonight_heavy),     0u }, nullptr },
    { "lethean",                        {POW(cryptonight_monero),           POW(cryptonight_monero),            0u }, {POW(cryptonight_r),          POW(cryptonight_r),         0u }, nullptr },
    { "masari",                         {POW(cryptonight_v8_half),          POW(cryptonight_v8_half),           0u }, {POW(cryptonight_r),          POW(cryptonight_r),         0u }, nullptr },
    { "monero",                         {POW(cryptonight_r),                POW(cryptonight_r),                 0u }, {POW(cryptonight_r),          POW(cryptonight_r),         0u }, "pool.supportxmr.com:5555" },
    { "plenteum",                       {POW(cryptonight_turtle),           POW(cryptonight_turtle),            0u }, {POW(cryptonight_turtle),     POW(cryptonight_turtle),    0u }, nullptr },
    { "qrl",                            {POW(cryptonight_monero),           POW(cryptonight_monero),            0u }, {POW(cryptonight_r),          POW(cryptonight_r),         0u }, nullptr },
