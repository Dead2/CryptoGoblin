...
xmrstak::coin_selection coins[] = {
    ...
    { "cryptonight_v8_reversewaltz", {POW(cryptonight_v8_reversewaltz), POW(cryptonight_v8_reversewaltz), 0u },  {POW(cryptonight_monero_v8), POW(cryptonight_monero_v8), 0u }, nullptr },
    ...
    { "graft",                   {POW(cryptonight_v8_reversewaltz), POW(cryptonight_monero_v8), 12u }, {POW(cryptonight_monero_v8), POW(cryptonight_monero_v8), 0u }, nullptr },
